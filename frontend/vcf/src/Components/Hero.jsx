        ...
        <div className="relative">
            ...
            <div className="absolute inset-0 bg-black/40 flex gap-10 flex-col justify-center items-center">
             ...
             <div className="flex gap-5">
                <Link className="border-1 rounded-[5px] p-4 text-3xl text-white hover:cursor-pointer hover:bg-white hover:text-black transition duration-700 ease-out hover:-translate-y-1" to="/predict">Start Prediction</Link>
